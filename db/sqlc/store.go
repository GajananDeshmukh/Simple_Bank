...
type Store struct {
	*Queries         //it is prefered way to extend struct functionality in golang instead inheritance
	db       *sql.DB //sql db object to create db transaction
}
...
// TransferTxParams contains the input paramter of the transfer transaction
